...
const SUFFIXES = ["bug","bugger","dude","boy","dude","son","baker","postman","milkman","pig","pog","pug","piggy","piglet","hog","hoglet","louse","shrimp","bob","builder","button","daddy","papa","peg","grunter","slater","pea","menace","beetle","wig","weg","wug","wood","crawler","wibble","nibbler","polie","poly"];
